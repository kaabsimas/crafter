...
from gamefactory import helpers
...
class Sprite(pg.sprite.Sprite):
    def __init__(self, game, x, y):
        ...
        self.game = game
        self.image = pg.Surface((self.game.TILEWIDTH / 2, self.game.TILEWIDTH / 2))
    ...
    def update(self):
        isoCoord = cartesian_to_isometric(self.x, self.y)
        self.rect.x = isoCoord[0]
        self.rect.y = isoCoord[1]
